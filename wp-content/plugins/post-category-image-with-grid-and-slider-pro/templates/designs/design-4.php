 ...
 *
 * This template can be overridden by copying it to yourtheme/post-category-image-with-grid-and-slider-pro/designs/design-4.php
 *
...
<div class="<?php echo esc_attr( $wrapper_cls ); ?>">
	<div class="pciwgas-post-cat-inner pciwgas-clearfix">
		...
		<div class="pciwgas-bottom-wrapper <?php if( $show_desc && $category_desc ) { echo 'pciwgas-has-desc'; } ?>">
