 ...
 *
 * This template can be overridden by copying it to yourtheme/post-category-image-with-grid-and-slider-pro/designs/design-2.php
 *
...
<div class="<?php echo esc_attr( $wrapper_cls ); ?>">
	<div class="pciwgas-post-cat-inner pciwgas-clearfix">
		<div class="pciwgas-img-wrapper" style="<?php echo esc_attr( $height_css ); ?>">
			...
			<?php if( ( $show_count && $category_count ) || ( $show_title && $category_name ) ) { ?>
