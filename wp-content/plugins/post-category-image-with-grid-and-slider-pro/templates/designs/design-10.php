<?php
/**
 * Template for - Design-10
 *
 * This template can be overridden by copying it to yourtheme/post-category-image-with-grid-and-slider-pro/designs/design-10.php
 *
		...
		<?php if( ( $show_title && $category_name ) || ( $show_desc && $category_desc ) ) { ?>
			<div class="pciwgas-bottom-wrapper">
				<?php if( $show_title && $category_name ) { ?>
					<div class="pciwgas-title"><a href="<?php echo esc_url( $term_link ); ?>" target="<?php echo esc_attr( $link_target ); ?>"><?php echo wp_kses_post( $category_name ); ?></a></div>
				<?php }
