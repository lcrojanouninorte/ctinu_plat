<?php
/**
 * Template for - Design-9
 *
 * This template can be overridden by copying it to yourtheme/post-category-image-with-grid-and-slider-pro/designs/design-9.php
 *
...
<div class="<?php echo esc_attr( $wrapper_cls ); ?>">
	<div class="pciwgas-post-cat-inner pciwgas-clearfix">
		<div class="pciwgas-img-wrapper" style="<?php echo esc_attr( $height_css ); ?>">
			...
			if( $show_title && $category_name ) { ?>
				<div class="pciwgas-title">
					<a class="pcffwp-title-overlay" href="<?php echo esc_url( $term_link ); ?>" target="<?php echo esc_attr( $link_target ); ?>"><?php echo wp_kses_post( $category_name ); ?></a>
				</div>
			<?php } ?>

			<div class="pciwgas-design-overlay"></div>
		...
		<?php if( $show_desc && $category_desc ) { ?>
