<?php
/**
 * Template for - Design-5
 *
 * This template can be overridden by copying it to yourtheme/post-category-image-with-grid-and-slider-pro/designs/design-5.php
 *
...
<div class="<?php echo esc_attr( $wrapper_cls ); ?>">
	<div class="pciwgas-post-cat-inner pciwgas-clearfix">
		...
		if( ( $show_count && $category_count ) || ( $show_title && $category_name ) || ( $show_desc && $category_desc ) ) { ?>
